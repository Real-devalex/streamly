...
export const movies: Movie[] = [
  ...
  },
  {
    ...
    description:
      'A physicist receives a distress signal from her own lab — sent forty-eight hours from now. Racing a clock that runs both ways, she must decide which future is worth saving.',
    posterUrl: placeholderImage('echoes-tomorrow-poster', 600, 900),
    backdropUrl: placeholderImage('echoes-tomorrow-backdrop', 1920, 1080),
    releaseYear: 2026,
    runtimeMinutes: 129,
    rating: 0,
    genres: genre('sci-fi', 'thriller'),
    cast: cast([
      ['Lena Ortiz', 'Dr. Wren Halloway'],
      ['Samir Khan', 'Ellis'],
    ]),
    downloadLinks: [],
    status: 'upcoming',
  ...
  },
  {
    ...
    slug: 'ash-and-amber',
    description:
      'Two rival glassblowers in a burning coastal town discover the fire that destroyed everything was lit to hide a century-old secret buried beneath their kilns.',
    posterUrl: placeholderImage('ash-amber-poster', 600, 900),
    backdropUrl: placeholderImage('ash-amber-backdrop', 1920, 1080),
    releaseYear: 2026,
    runtimeMinutes: 112,
    rating: 0,
    genres: genre('drama', 'mystery'),
    cast: cast([
      ['Isolde Brandt', 'Amber Vance'],
      ['Kofi Mensah', 'Ash Diallo'],
    ]),
    downloadLinks: [],
    status: 'upcoming',
    featured: false,
  ...
  },
  {
    ...
    slug: 'paper-tigers',
    description:
      'A retired con artist is pulled back for one last job: stealing a forged painting back from the museum that unknowingly bought her masterpiece.',
    posterUrl: placeholderImage('paper-tigers-poster', 600, 900),
    backdropUrl: placeholderImage('paper-tigers-backdrop', 1920, 1080),
    releaseYear: 2026,
    runtimeMinutes: 118,
    rating: 0,
    genres: genre('crime', 'comedy'),
    cast: cast([
      ['Vivienne Marchetti', 'Odile'],
      ['Bruno Castellan', 'Felix'],
    ]),
    downloadLinks: [],
    status: 'upcoming',
    featured: false,
